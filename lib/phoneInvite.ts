...
export async function addByPhone(args: {
  ...
  const inviteText = `${inviterLabel} invited you to split expenses on NestExpenseTracker (${householdLabel}). Get the app: ${APP_STORE_URL} — then verify this phone number to join.`;
